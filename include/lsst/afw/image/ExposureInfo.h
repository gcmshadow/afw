...
public:
    ...
    [[deprecated("Replaced with getFilterLabel. Will be removed after v23.")]] Filter getFilter() const;
     ...
     */
    // TODO: remove in DM-27177
    [[deprecated("Replaced with setFilterLabel. Will be removed after v23.")]] void setFilter(
            Filter const& filter);
