...
class ExposureInfoTestCase(lsst.utils.tests.TestCase):
    def setUp(self):
        ...
        self.psf = DummyPsf(2.0)
        self.detector = DetectorWrapper().detector
        self.summary = afwImage.ExposureSummary()
    ...
    def testAliases(self):
        ...
        self._checkAlias(self.exposureInfo, cls.KEY_SUMMARY, self.summary,
                         self.exposureInfo.hasSummary, self.exposureInfo.getSummary)
